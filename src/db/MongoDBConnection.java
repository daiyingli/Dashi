...
public class MongoDBConnection implements DBConnection {
    ...
    // better design     DBconnection Interface
    //                      Abstract dbConnection
    //                         /             \
    //                   MYsql connection    mangodb connection
    // recommend is the same as MysqlConnection api
    @Override
    ...
    public JSONArray searchRestaurants(String userId, double lat, double lon) {
    	 try {
       		 ...
       		 for (int i = 0; i < array.length(); i++) {
       			 ...
       			 // above code is the same as the MYSQLConnection, the only difference is the code 
       			 // related to db connections.
